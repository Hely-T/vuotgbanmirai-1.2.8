...
"https://i.pinimg.com/236x/a3/b2/46/a3b246d8e3c48ba50283cda5a357c2aa.jpg",
	 ...
	 var callback = () => api.sendMessage({body:`Chúc mừng, đây là ảnh jack dành cho bạn: ${link.length}`,attachment: fs.createReadStream(__dirname + "/src/2.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/src/2.jpg"));	
      return request(encodeURI(link[Math.floor(Math.random() * link.length)])).pipe(fs.createWriteStream(__dirname+"/src/2.jpg")).on("close",() => callback());
   };